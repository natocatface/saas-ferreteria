...
<div class="flex min-h-screen">
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center gap-3 px-5 h-16 border-b border-navy-light shrink-0">
            ...
            <div>
                <p class="font-extrabold text-white text-lg leading-none">Ferre<span class="text-teal-brand">Max</span></p>
    ...
    <div class="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <footer class="px-6 py-4 text-xs text-slate-400 text-center">
            FerreMax SaaS © {{ date('Y') }} — Sistema de gestión para ferreterías
        </footer>
    </div>
</div>
